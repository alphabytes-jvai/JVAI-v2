...
//                   currentPage === 1 ? "bg-gray-600 cursor-not-allowed" : "bg-[#0043f8] hover:bg-blue-700"
...
//                       currentPage === index + 1 ? "bg-[#0043f8]" : "bg-gray-600 hover:bg-gray-500"
//                     } text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400`}
...
//                 className={`p-2 rounded-full ${
//                   currentPage === totalPages ? "bg-gray-600 cursor-not-allowed" : "bg-[#0043f8] hover:bg-blue-700"
//                 } text-white transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400`}
